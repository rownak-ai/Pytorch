...
#List = ["Block",no of repeats] #residual block along with no of repeats
#'S' is scale perdiction block and computing the yolo loss
...
class ResidualBlock(nn.Module):
    def __init__(self,channels,use_residual=True,num_repeats=1):
        ...
        for _ in range(num_repeats):
            #Reduces no of filters and bring it back again
            self.layers += [
                nn.Sequential(
